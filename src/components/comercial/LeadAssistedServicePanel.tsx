      ...
      body: JSON.stringify({
        ...
        journeyContext: {
          ...
          timeline: {
            ...
            detectedRegions: timelineContext.detectedRegions ?? [],
            detectedRegionLabels: timelineContext.detectedRegionLabels ?? [],
            detectedSubregions: timelineContext.detectedSubregions ?? [],
            regionSummaryForAI: timelineContext.regionSummaryForAI ?? "",
          },
        },
      }),
    });
